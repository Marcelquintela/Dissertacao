...
# Programa: AJUSTE DOS BANCOS DE DADOS CENSO 2000                            #
## *************************************************************************##
...
c<-29
for (i in 1:length(c)){
  dados <- read.spss(paste("04.Banco.de.Dados\\Banco\\2000-",c[i],".sav",sep="")
                     ,use.value.labels=F,to.data.frame=T)
  save(dados, file=paste("04.Banco.de.Dados\\Banco\\2000-",c[i],".rda",sep=""))
  rm(dados)
}
